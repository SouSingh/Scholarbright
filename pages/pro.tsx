...
export default function PagePrivacy() {
  return (
    <LayoutPage title="Pro" description="See how Scholarbright respects your privacy and the users data.">
      <section className="colors">
        <div className={Style.container}>
          <div className={Style.pageTitle}>
            <h1>Scholarbright Pro</h1>
      ...
      <section>
        <div className={Style.container}>
          <h2>Why buy Pro?</h2>
          <p>Scholarbright is always free, but if you want to get powerful features, like:</p>
          ...
          <p>
            Consider buy a Scholarbright Pro license - and you are also supporting the open and
            decentralized web!
          </p>
        </div>
      </section>
