...
export default function PagePrivacy() {
  return (
    <LayoutPage
      ...
      description="See how Scholarbright respects your privacy and the users data.">
      <section className="colors">
        <div className={Style.container}>
          <div className={Style.pageTitle}>
            <h1>Scholarbright Privacy Policy</h1>
          </div>
        </div>
      </section>
        ...
        <div className={Style.container}>
          <article>
            ...
            <p>
              ...
              internet service <a href="http://Scholarbright.app">http://Scholarbright.app</a> or another medium
              ("Scholarbright").
            </p>

            <p>
              Scholarbright don't store any user searches. Because was designed for it. Scholarbright mission is
              encourage people choice a healthy internet. External search provider services may
              collect and store your personal data. Thinking about it, Scholarbright displays a "Privacy
              level widget" on top of every search provider, whenever available.
            </p>

            <p>
              Scholarbright endorses user control over their data. This privacy policy have accordance with
            ...
            <p>Using Scholarbright you are agreeing to be bound by this privacy policy. </p>

            <h2>2. Automatically Collected Information</h2>

            <p>
              Scholarbright automatically collect and store minimal public information (non personal data)
            ...
            <p>
              Scholarbright only receives and stores identifiable information (personal data) for those who
            ...
            <p>
              Scholarbright only ask for personal information when we truly need it to provide a service to
            ...
            <p>Scholarbright uses your information only with the purposes of: </p>
            ...
            <p>
              Scholarbright and it's related email communications, use cookies and similar technologies,
            ...
            <p>
              ...
              services are used to optimize Scholarbright, and can put their own cookies in your browser.
            ...
            <p>
              Scholarbright do not share any personally identifying information with third-parties. But for
            ...
            <p>
              Scholarbright only retain collected information for as long as necessary to provide to you
            ...
            <p>
              Scholarbright strongly encourages you take a look on third parties privacy policies linked
            ...
            <p>
              Scholarbright redirects and contain links to external websites and applications just for your
              convenience of search functionality. Please be aware, that Scholarbright not endorse, have no
              ...
              are not operated by Scholarbright. We advised you to review the privacy policy of every them,
              as possible.
            </p>
            ...
            <p>
              ...
              changes will be announced on Scholarbright's communication channels. Your continued use of
              Scholarbright, following the posting of changes, will be regarded as acceptance of these
              changes.
            </p>
