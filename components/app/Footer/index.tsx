  ...
  return (
    <footer className={Style.footer}>
      <div className={Style.container + ' container'}>
        <figure>
          <Link href="/" title="Scholarbright">
            <SvgLogo />
          </Link>
        </figure>

        <p>
          {data?.t?.copyright[0] ?? 'Scholarbright is made by'}{' '}
        ...
        <ul>
          ...
          <li>
            <Link href="https://x.com/Scholarbrightapp" target="_blank" rel="noreferrer" aria-label="X">
              <IconX />
            </Link>
          </li>
          <li>
        ...
        {/* <a
            href="https://instagram.com/Scholarbrightapp"
            target="_blank"
            rel="noreferrer"
            title="Instagram">
            <Instagram />
        ...
        {/* <a
            href="https://linkedin.com/company/Scholarbright/"
            target="_blank"
            rel="noopener"
            title="LinkedIn">
            LinkedIn
        ...
        {/* <a
            href="https://facebook.com/Scholarbrightapp"
            target="_blank"
            rel="noopener"
            title="Facebook">
            Facebook
        ...
        {/* <a
          href="https://youtube.com/Scholarbrightapp"
          target="_blank"
          rel="noopener"
          title="YouTube">
          YouTube
